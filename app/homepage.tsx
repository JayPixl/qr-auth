    ...
    return <div className='p-8 flex flex-col lg:flex-row w-full h-[90vh] items-center justify-evenly'>
        {user ? <>
            <div className='w-full flex justify-center'>
                <div className="w-48 h-48 md:w-64 md:h-64 bg-white p-1 rounded-xl border-4 border-rose-500 drop-shadow-[0px_0px_32px_rgba(244_62_94_/_0.8)] hover:drop-shadow-[0px_0px_48px_rgba(244_62_94_/_0.9)] transition">
            ...
            <div className='w-full flex flex-col items-center justify-center'>
                <div className="text-2xl flex flex-col items-center justify-center">
                    <Link href='/login' className="text-rose-500 font-semibold text-3xl hover:scale-105 transition">Log in here</Link>
                    <div className="font-light text-lg my-5">- or -</div>
